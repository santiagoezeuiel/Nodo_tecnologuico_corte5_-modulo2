import {contadorS} from "./modulo08.js";



window.onload = () => {

    //Controlamos en la consola si esta levantando el controlador 09
    console.log(`El controlador 09 esta funcioanndo`);
    ...
    //Comprovar en la consola los componentes
    console.log(idtexto);
    ...
    idcalcular.onclick = () => {
        ...
        const resultado = contadorS(texto);
        ...
        if (resultado) {
            ...
            <p style="
                    ...
                    display: inline-block;
                "> 
                    <span style="color:green;">La palabra contiene al menos dos letras "S".</span><br>
            </p>`;
        } else {
            idresultado.innerHTML = `
            <p style="
                    ...
                    display: inline-block;
                "> 
                    <span style="color:#ff0000ff;">La palabra NO contiene dos letras "S".</span<br>
            </p>`;
        }
    }
