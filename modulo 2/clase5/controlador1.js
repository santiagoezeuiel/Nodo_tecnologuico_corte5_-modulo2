...
👉 Comercios de todos los rubros (que cumplan con los requisitos y estén debidamente encuadrados) 
podrán ofrecer estos increíbles beneficios a sus clientes:
    ...
    */
    ...
    switch(rubroOperacion)
    {
        ...
        case 3: // VESTIMENTAS Y OTROS RUBROS
            {
                console.log(`Ud. Eligió el rubro de Vestimenta y otrso Rubros y tiene un descuento del 20% y tope de 
                    $ 80.000 Lunes, martes y miércoles `);
